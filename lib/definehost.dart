final String host ="192.168.0.6:8000";
final String apiLogin ="/api/auth/login";
final String apiUploadImgToTrain ="/api/auth/uploadimage";
final String apiAddFace ="/api/auth/addface";
