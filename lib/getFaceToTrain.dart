...
class GetFaceToTrain extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return _GetFaceToTrainState();
  }
}

class _GetFaceToTrainState extends State<GetFaceToTrain> {
  // File jsonFile;
  ...
  void _initializeCamera() async {
    var extenar = await getExternalStorageDirectory();
    final path = extenar.path;
    print(path);
    // await loadModel();
          ...
          (dynamic result) async {
            ...
            if (numImageSave < 10) {
              if (random.nextInt(5) == 2) {
                File(path + '/avatar$numImageSave.jpg')
  ...
  Widget processUploadImage() {
    return Container(
      child: Center(
        child: Column(
          children: [
            Text(
              'Waiting for process image',
